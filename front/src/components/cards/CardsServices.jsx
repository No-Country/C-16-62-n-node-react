    ...
    >
      <a href="#">
        <img
          ...
          src="{{ departament.thumbnail }}"
          alt="departaments_image"
        />
      </a>
      <div className="px-5 pb-5">
        ...
        <div flex items-center mt-2 mb-3>
          <span
            className="bg-blue-100 text-blue-800 text-xs font-semibold px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800 ms-3"
            >2 Baños</span
          >
        ...
        <div className="flex items-center justify-between">
          <span className="text-3xl font-bold text-gray-900 dark:text-white"></span>7 días<span></span>
          <a
